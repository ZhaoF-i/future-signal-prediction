...
`speech-target.wav`, `speech-baseline.wav`, `speech-suppressed.wav`, and `speech-spectrogram.32b588a5085a.png` derive from LibriSpeech test-clean utterance **1089-134691-0003**.
The derived `speech-baseline-error.wav`, `speech-suppressed-error.wav`, and `speech-error-spectrogram.9456ad7fd3e7.png` retain the same attribution and license.
...
`noise-target.wav`, `noise-baseline.wav`, `noise-suppressed.wav`, and `noise-spectrogram.f2ddc6d23b94.png` derive from DEMAND's NPARK recording, saved evaluation segment **NPARK_S00641_seg0015**.
The derived `noise-baseline-error.wav`, `noise-suppressed-error.wav`, and `noise-error-spectrogram.3ab15a491a91.png` retain the same attribution and license.
