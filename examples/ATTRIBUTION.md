...
`speech-target.wav`, `speech-baseline.wav`, `speech-suppressed.wav`, and `speech-spectrogram.50e1cbea826e.png` derive from LibriSpeech test-clean utterance **1089-134691-0003**.
The derived `speech-baseline-error.wav`, `speech-suppressed-error.wav`, and `speech-error-spectrogram.0a02c8450d08.png` retain the same attribution and license.
...
`noise-target.wav`, `noise-baseline.wav`, `noise-suppressed.wav`, and `noise-spectrogram.f578c1d08ba0.png` derive from DEMAND's NPARK recording, saved evaluation segment **NPARK_S00641_seg0015**.
The derived `noise-baseline-error.wav`, `noise-suppressed-error.wav`, and `noise-error-spectrogram.e563474eb7f2.png` retain the same attribution and license.
